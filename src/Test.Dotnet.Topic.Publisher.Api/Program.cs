...
using Test.Dotnet.Topic.Publisher.Api.Config;
using Test.Dotnet.Topic.Publisher.Api.Extensions;
...
namespace Test.Dotnet.Topic.Publisher.Api;
...
public static class Program
{
    ...
    public static void ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        {
            config.SwaggerDoc("v1", new OpenApiInfo { Title = "Test.Dotnet.Topic.Publisher", Version = "v1" });
        });
